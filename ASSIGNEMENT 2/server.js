...
const uri = `mongodb+srv://dbUser:dbUserPassword@cluster0.xwbus.mongodb.net/${DATABASE_NAME}?retryWrites=true&w=majority`;


let collection = null;
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
client.connect(err=> {
  collection = client.db(DATABASE_NAME).collection('Image');
