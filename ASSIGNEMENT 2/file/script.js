...
/*function debugTopFrame(base64URL){
    var win = window.open();
...
const Save = () => {
    savemongo();
    let user_message2 = document.getElementById('user_message2')
    user_message2.innerHTML = `Successfully uploaded!`

}

const Saved = (url) => {
    console.log('Lets begin');
    URL = 'https://asstwowebsite.herokuapp.com/savedfile'
    windows = window.open(URL);
}
